...
export const essayGradingSchema = {
  ...
  properties: {
    transcript: { type: 'string' }, recognitionWarnings: { type: 'array', items: { type: 'string' } }, printedTextExcluded: { type: 'boolean' }, reportedTotalScore: { type: 'number' }, dimensionScores: { type: 'array', items: dimensionScoreSchema }, issues: { type: 'array', maxItems: 100, items: issueSchema }, sentenceRevisions: { type: 'array', maxItems: 100, items: revisionSchema }, expressionUpgrades: { type: 'array', items: upgradeSchema },
