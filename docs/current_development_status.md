...
- 本次记忆更新前的最新实现提交：`146caea feat: add issue locate fallback feedback`
...
- 已完成问题卡片到原文定位的轻量闭环：
  - 右侧“问题与修改建议”卡片可点击选中。
  - 选中卡片显示“正在定位原文”状态。
  - 左侧“学生作文原文”保留 OCR textarea 编辑能力。
  - 选中问题后，左侧出现“定位预览”，并高亮匹配到的原句。
...
- 浏览器交互验证：
  ...
  - 点击第一条问题卡片后，右侧卡片显示“正在定位原文”。
  - 左侧出现“定位预览”，并高亮 `I suggest you joins the club.`。
  - 点击“加入班级总览”后，按钮变为“已加入班级总览”，且不破坏当前问题选中状态。
